...
function hi_html_viewer_app_language_简体中文_config(){
    ...
    hi_html_viewer_ui_option_settings_language=["偏好设置","在链接里添加UTF-8属性","顶部栏和菜单栏的透明化","应用程序主题偏好","框架透明化","语言","本地存储","背景透明化"]
...
function hi_html_viewer_app_language_繁體中文_config(){
    ...
    hi_html_viewer_ui_option_settings_language=["偏好設定","在連結裡添加UTF-8屬性","頂部欄和菜單欄的透明化","應用程式主題偏好","框架透明化","語言","本地存儲","背景透明化"]
...
function hi_html_viewer_app_language_config() {
    ...
    document.getElementById("hi_html_viewer_backgorund_transparent_color_title").innerHTML=hi_html_viewer_ui_option_settings_language[7]
    ...
    document.getElementById("hi_html_viewer_backgorund_transparent_color").title=hi_html_viewer_ui_option_settings_language[7]
    ...
    document.getElementById("hi_html_viewer_backgorund_transparent_color_select_option_1").innerHTML=hi_html_viewer_ui_option_settings_select_option_language[2]
    document.getElementById("hi_html_viewer_backgorund_transparent_color_select_option_2").innerHTML=hi_html_viewer_ui_option_settings_select_option_language[4]
